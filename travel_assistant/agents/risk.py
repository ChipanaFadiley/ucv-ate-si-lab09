# Agente enfocado en evaluar riesgos del viaje y dar recomendaciones preventivas.
...
""",
    tools=[assess_basic_travel_risks],  # Herramienta personalizada de evaluación de riesgos.
)
