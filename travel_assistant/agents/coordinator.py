# Agente coordinador que recibe y delega las solicitudes de viaje a subagentes.
...
- Use local_culture_agent to obtain local dishes, customs, and phrases.
...
6. Local culture (typical dishes, important customs, and useful phrases for the destination).
7. Final advice.
...
""",
    sub_agents=[
        ...
        budget_agent,
        risk_reviewer_agent,
        local_culture_agent,  # Integrado como subagente según el Reto.
    ],
)
