# Agente especializado en calcular presupuestos utilizando la herramienta estimate_trip_budget.
...
""",
    tools=[estimate_trip_budget],  # Herramienta personalizada de cálculo.
)
