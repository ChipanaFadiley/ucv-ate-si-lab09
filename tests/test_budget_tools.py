# Pruebas unitarias para la herramienta de estimación de presupuesto.
from travel_assistant.tools.budget_tools import estimate_trip_budget


def test_estimate_trip_budget_success():
    # Caso exitoso: días y presupuesto diario válidos.
...
def test_estimate_trip_budget_invalid_days():
    # Caso fallido: días igual o menor que cero.
...
def test_estimate_trip_budget_invalid_daily_budget():
    # Caso fallido: presupuesto diario igual o menor que cero.
